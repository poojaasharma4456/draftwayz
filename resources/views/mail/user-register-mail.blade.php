        ...
        <table width="100%" cellspacing="0">
            <tr style="padding: 20px; text-align: center; color: #ffffff;">
                <td style="padding: 10px;">
                    <a href="#" target="_blank"> <img src="{{ env('SITE_DOMAIN') }}{{ asset('assets/images/Logo-dark-n.png') }}" alt="logo"
            ...
            <table style=" margin-top: 20px; padding: 0 30px;" cellspacing="0" width="100%">
                <tr>
                    <td>
            ...
            {{-- <table style="border-top: 1px solid #00c900;  padding-top: 20px; margin-top: 20px;" cellspacing="0" width="100%">
                <tr style="display: flex; justify-content: center; gap: 20px;">
                    ...
                    <td
                        style="width: 40px; height: 40px;  border-radius: 50%;    background-image: linear-gradient(135deg, #00c900 0%, #8ae501 100%); display: flex; justify-content: center; align-items: center; " onmouseover="this.style.backgroundColor='#e0e0e0';">
